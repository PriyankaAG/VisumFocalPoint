...
namespace FocalPoint.Modules.FrontCounter.Views
{
    ...
    public partial class QuickOrderDetailsSalableView : ContentPage
    {
        ...
        public QuickOrderDetailsSalableView(Order curOrder)
        {
            InitializeComponent();
        ...
        {
            ((QuickOrderDetailsSalableViewModel)this.BindingContext).GetSearchedCustomersInfo((sender as TextEdit).Text);
        }
        private void TextEdit_Cleared(object sender, EventArgs e)
        {
            ((QuickOrderDetailsSalableViewModel)this.BindingContext).GetSearchedCustomersInfo("");
        }
        ...
        private async Task FinishQuestions(int count)
        {
            ...
            do
            {
                UpdatedOrder = ((QuickOrderDetailsSalableViewModel)this.BindingContext).AddItem(selItem, count, CurrentOrder, UpdatedOrder, out questionFault);
                ...
                {
                    MessagingCenter.Send<QuickOrderDetailsSalableView, OrderUpdate>(this, "Hi", UpdatedOrder);
                    await Navigation.PopAsync();
                }
