...
namespace FocalPoint.Modules.FrontCounter.Views
{
    ...
    public partial class QuickOrderDetailsRateView : ContentPage
    {
        ...
        public QuickOrderDetailsRateView(Order curOrder)
        {
            InitializeComponent();
        ...
        {
            ((QuickOrderDetailsRateViewModel)this.BindingContext).GetSearchedCustomersInfo((sender as TextEdit).Text);
        }
        private void TextEdit_Cleared(object sender, EventArgs e)
        {
            ((QuickOrderDetailsRateViewModel)this.BindingContext).GetSearchedCustomersInfo("");
        }
        ...
        private async Task FinishQuestions(int count)
        {
            ...
            do
            {
                UpdatedOrder = ((QuickOrderDetailsRateViewModel)this.BindingContext).AddItem(selItem, count, CurrentOrder, UpdatedOrder, out questionFault);
                ...
                {
                    MessagingCenter.Send<QuickOrderDetailsRateView, OrderUpdate>(this, "Hi", UpdatedOrder);
                    await Navigation.PopAsync();
                }
